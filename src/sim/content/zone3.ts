...
export const ZONE3_MOBS: Record<string, MobTemplate> = {
  ...
  thunzharr_waking_peak: {
    ...
    loot: [
      { itemId: 'inert_storm_shard', chance: 1 },
      { itemId: 'crownforged_gauntlets', chance: 0.2, rollGroup: 'thunzharr_t2' },
      { itemId: 'nighttalon_grips', chance: 0.2, rollGroup: 'thunzharr_t2' },
      { itemId: 'stormcallers_handguards', chance: 0.2, rollGroup: 'thunzharr_t2' },
      { itemId: 'soulflame_gloves', chance: 0.4, rollGroup: 'thunzharr_t2' },
      { itemId: 'crownforged_girdle', chance: 0.2, rollGroup: 'thunzharr_t2_belt' },
      { itemId: 'nighttalon_waistband', chance: 0.2, rollGroup: 'thunzharr_t2_belt' },
      { itemId: 'stormcallers_waistguard', chance: 0.2, rollGroup: 'thunzharr_t2_belt' },
      { itemId: 'soulflame_cord', chance: 0.4, rollGroup: 'thunzharr_t2_belt' },
      { itemId: 'vestments_of_the_waking_grove', chance: 0.15, rollGroup: 'thunzharr_t2_bonus' },
    ],
