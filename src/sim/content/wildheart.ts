...
export const WILDHEART_MOBS: Record<string, MobTemplate> = {
  ...
  wildheart_high_priest: {
    ...
    loot: [
      ...
      { itemId: 'wildheart_tuskblade', chance: 0.25, rollGroup: 'wildheart_bonus' },
      { itemId: 'wildheart_fangknife', chance: 0.25, rollGroup: 'wildheart_bonus' },
      { itemId: 'wildheart_hexwood_staff', chance: 0.5, rollGroup: 'wildheart_bonus' },
    ],
    scale: 2.8,
    color: 0x566f45,
  },
