...
export const DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  korgath_the_bound: {
    ...
    loot: [
      ...
      { itemId: 'boneplate_vest', chance: 0.09, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'revenant_silk_robe', chance: 0.09, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'nightwalk_jerkin', chance: 0.09, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'zealotsbane_blade', chance: 0.09, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'korgaths_chainwraps', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'staff_of_velkhar', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'shadowmeld_tunic', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'wyrmcult_grand_robe', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'gravewyrm_sabatons', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'wyrmcult_soulsteps', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'boundstone_helm', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'gravewyrm_mantle', chance: 0.08, rollGroup: 'korgath_guaranteed_uncommon' },
      { itemId: 'wyrmshadow_treads', chance: 0.15, rollGroup: 'korgath_bonus' },
      { itemId: 'grovewardens_grips', chance: 0.15, rollGroup: 'korgath_bonus' },
      { itemId: 'wildgrowth_leggings', chance: 0.15, rollGroup: 'korgath_bonus' },     
      { itemId: 'verdant_walkers', chance: 0.15, rollGroup: 'korgath_bonus' },
    ],
    scale: 1.5,
    color: 0x8f6f46,
  },
  grand_necromancer_velkhar: {
    ...
    loot: [
      { copper: 5000, chance: 1 },
      { itemId: 'boneplate_vest', chance: 0.15, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'revenant_silk_robe', chance: 0.15, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'nightwalk_jerkin', chance: 0.15, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'emberwood_staff', chance: 0.15, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'boneguard_breastplate', chance: 0.1, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'shadowmeld_tunic', chance: 0.1, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'staff_of_velkhar', chance: 0.1, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'gravewyrm_stalkers_treads', chance: 0.1, rollGroup: 'velkhar_guaranteed_uncommon' },
      { itemId: 'deathlord_legguards', chance: 0.15, rollGroup: 'velkhar_bonus' },
      { itemId: 'wyrmshadow_legguards', chance: 0.15, rollGroup: 'velkhar_bonus' },
      { itemId: 'necromancers_soulsteps', chance: 0.2, rollGroup: 'velkhar_bonus' },
    ],
    scale: 1.25,
    color: 0x512e5f,
  },
  korzul_the_gravewyrm: {
    ...
    loot: [
      ...
      { itemId: 'boneplate_vest', chance: 0.15, rollGroup: 'korzul_guaranteed_uncommon' },
      { itemId: 'revenant_silk_robe', chance: 0.15, rollGroup: 'korzul_guaranteed_uncommon' },
      { itemId: 'nightwalk_jerkin', chance: 0.15, rollGroup: 'korzul_guaranteed_uncommon' },
      { itemId: 'cultist_flayer', chance: 0.15, rollGroup: 'korzul_guaranteed_uncommon' },
      { itemId: 'boundstone_girdle', chance: 0.2, rollGroup: 'korzul_guaranteed_uncommon' },
      { itemId: 'gravewyrm_gauntlets', chance: 0.2, rollGroup: 'korzul_guaranteed_uncommon' },
      { itemId: 'deathlords_dread_visage', chance: 0.15, rollGroup: 'korzul_bonus' },
      { itemId: 'wyrmshadow_harness', chance: 0.15, rollGroup: 'korzul_bonus' },
      { itemId: 'deathlord_warplate', chance: 0.15, rollGroup: 'korzul_bonus' },
      { itemId: 'wyrmshadow_talongrips', chance: 0.15, rollGroup: 'korzul_bonus' },
      { itemId: 'necromancers_starshroud', chance: 0.2, rollGroup: 'korzul_bonus' },
      { itemId: 'necromancers_soulspire_mantle', chance: 0.2, rollGroup: 'korzul_bonus' },
      { itemId: 'fang_of_korzul', chance: 0.15, rollGroup: 'korzul_bonus_weapon' },
      { itemId: 'wyrmfang_greatblade', chance: 0.15, rollGroup: 'korzul_bonus_weapon' },
      { itemId: 'nightfangs_greatstaff', chance: 0.15, rollGroup: 'korzul_bonus_weapon' },
      { itemId: 'staff_of_the_gravewyrm', chance: 0.2, rollGroup: 'korzul_bonus_weapon' },
      ...
      { itemId: 'gravewyrm_bone_quiver', chance: 0.15, rollGroup: 'korzul_bonus_weapon' },
    ],
    scale: 1.8,
    color: 0x3d5c45,
  },
  ...
  nythraxis_scourge_of_thornpeak: {
    ...
    loot: [
      ...
      { itemId: 'direfang_quiver', chance: 0.12, rollGroup: 'nythraxis_drop_3' },
      ...
      { itemId: 'soulflame_cowl', chance: 0.16, rollGroup: 'nythraxis_drop_3' },
      ...
      { itemId: 'direfang_greatblade', chance: 0.12, rollGroup: 'nythraxis_drop_4' },
      { itemId: 'soulflame_mantle', chance: 0.18, rollGroup: 'nythraxis_drop_4' },
      ...
      { itemId: 'wraithfire_orb', chance: 0.4, rollGroup: 'nythraxis_drop_5' },
